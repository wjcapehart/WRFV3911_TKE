...
;
   ...
   SPAWN, 'mkdir -v '   + WRF_OUTSTORE
          ...
          WRF_SM_FILENAMES = "wrfout_d01_" +  SUBOUT_DATE_STRING_SM + ".nc"
          FOR TT = 0L, NT_SUBOUTFILES-1L DO $
              SPAWN, '/usr/local/netcdf/bin/nccopy -4 -d 5 ' + WRF_FILENAMES(TT) + ' ' + WRF_SM_FILENAMES(TT)
          FOR TT = 0L, NT_SUBOUTFILES-1L DO $
...
final_clocktime = systime(/UTC) + " UTC"
   ...
   ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ;; run UPP
      spawn, wrf_program_root_dir + "/UPPV3.2/scripts/run_unipost_SDSMT >& /home/wjc/WRF_REALTIME/UPP.log"
